...
[![Version](https://img.shields.io/badge/version-3.8.24-green)](https://github.com/dorukardahan/ZeroAPI/releases/tag/v3.8.24)
...
Prefer exact version installs such as `clawhub:zeroapi@3.8.24` instead of an unpinned `latest` install. Do not install mirror packages, standalone skills, or similarly named packages that do not link back to this repository.
