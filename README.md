...
[![Version](https://img.shields.io/badge/version-3.10.4-green)](https://github.com/dorukardahan/ZeroAPI/releases/tag/v3.10.4)
...
Prefer exact version installs such as `clawhub:zeroapi@3.10.4` instead of an unpinned `latest` install. Do not install mirror packages, standalone skills, or similarly named packages that do not link back to this repository.
