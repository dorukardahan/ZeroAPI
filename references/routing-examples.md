...
|--------|----------|-----------|--------|
| `refactor the auth module` | CODE | GPT-5.5 | coding leader, keyword: `refactor` |
| `research the differences between WAL modes` | RESEARCH | GPT-5.5 | GPQA leader, keyword: `research` |
